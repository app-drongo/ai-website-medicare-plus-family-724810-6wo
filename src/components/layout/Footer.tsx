...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    "Your trusted family clinic providing comprehensive healthcare services including telemedicine and in-person visits. We're committed to making quality healthcare accessible and convenient for you and your family.",
  contactEmail: 'info@medicareplus.com',
  contactPhone: '+1 (555) MEDCARE',
  contactAddress: '123 Health Plaza, Medical District',
  newsletterTitle: 'Health Updates',
  newsletterPlaceholder: 'Enter your email for health tips',
  newsletterDisclaimer:
    'Get health tips, appointment reminders, and clinic updates. HIPAA compliant, unsubscribe anytime.',
  section1Title: 'Services',
  section2Title: 'Clinic',
  section3Title: 'Patient Resources',
  section4Title: 'Privacy & Legal',
  copyrightText: '© 2024 MediCare Plus Family Clinic. All rights reserved.',
  madeWithText: 'with care for your health',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/medicareplus',
  social2Href: 'https://facebook.com/medicareplus',
  social3Href: 'https://instagram.com/medicareplus',
  social4Href: 'https://linkedin.com/company/medicareplus',
  social5Href: 'https://github.com/medicareplus',
} as const;
